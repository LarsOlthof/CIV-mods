...
-- the individual values set for each denomination pack. Specific religions may still be enabled with Historical Religions Lite using the
-- 'LITE MODE EXCEPTIONS' section below.
--
...
--	
-- Note: The base Christian denominations (Catholicism, Eastern Orthodoxy, Oriental Orthodoxy and Protestantism) are still enabled when 'HR_LITE_MODE' is set to 1,
-- but can be fully disabled by setting 'HR_CHRISTIAN_DENOMINATIONS' to 0.
--
...
--
-- All denomination packs (except the base 'HR_CHRISTIAN_DENOMINATIONS' option) require 'HR_LITE_MODE' to be set to 0.
--
-- Default Values: 1
--==========================================================================================================================	
--==========================================================================================================================	
...
INSERT INTO HR_Denominations
		(Type,					Value)
VALUES		('HR_CHRISTIAN_DENOMINATIONS',		    1); ---- [0: Christianity <-> 1: Catholicism, Eastern Orthodoxy, Oriental Orthodoxy, Protestantism]
...
VALUES		('HR_PROTESTANT_EXTENDED',		    1), ---- [0: Protestantism <-> 1: Lutheranism, Calvinism, Anabaptism, Baptist Christianity, Methodism /*]
		('HR_ANGLICAN_EXTENDED',		    1), ---- [0: (No Change) <-> 1: (Adds) Anglicanism /*]	
		('HR_CHRISTIAN_EXTENDED',		    1), ---- [0: (No Change) <-> 1: (Adds) Nestorianism, Restorationism /*]		
...
VALUES		('HR_ISLAMIC_DENOMINATIONS',		    1),	---- [0: Islam <-> 1: Sunni, Shia, Ibadiyyah]
		--						
		('HR_SHIA_EXTENDED',		    	    1), ---- [0: Shia <-> 1: Zaidiyyah, Imamiyyah, Ismailiyyah, Alawiyyah /*]
...
--
-- The following options can be used to enable specific religions even if 'HR_LITE_MODE' is set to 0. This option group is not meant to be extensive,
-- but rather facilitate specific requests.
--
-- Default Value: 0
--==========================================================================================================================
--==========================================================================================================================	
...
INSERT INTO HR_Denominations
		(Type,					Value)
VALUES		('HR_ANGLICAN_LITE_EXCEPTION',		    0), ---- [1: (No Change) <-> 1: (Adds) Anglicanism when Historical Religions Lite is enabled /*]
		('HR_FORN_SIDR_LITE_EXCEPTION',		    0); ---- [1: (No Change) <-> 1: (Adds) Forn Sidr when Historical Religions Lite is enabled]
								---- [/* Note: 'HR_ANGLICAN_LITE_EXCEPTION' still requires 'HR_CHRISTIAN_DENOMINATIONS' set to 1 and functions independently of 'HR_ANGLICAN_EXTENDED'.]
...
VALUES		('HR_PREFERENCE_GERMANY',		    0),	---- [0: (Barbarossa's Preference) <-> 1: Christianity (Protestantism (Lutheranism)) /*]
		...
		('HR_PREFERENCE_VIKING',		    0);	---- [0: (Hardrada's Preference) <-> 1: Forn Sidr /*]
								...
								---- [/* Note: Protestantism (Lutheranism) also requires 'HR_CHRISTIAN_DENOMINATIONS' set to 1. Forn Sidr also requires either 'HR_LITE_MODE' set to 0 or 'HR_FORN_SIDR_LITE_EXCEPTION' set to 1.]
...
--
-- The third set of options allows you to disable individual religions. This option group is not meant to be extensive, but rather
-- facilitate specific requests (viz. removing Mi-chos for individuals not wanting swastika styled icons to appear in the game).
--
-- The fourth set of options allows you to disable the 4 base game religions not preferred by a standard leader (Confucianism, Judaism, Shinto, Sikhism).
-- 
-- Default Values: 0
--==========================================================================================================================
--==========================================================================================================================
...
INSERT INTO HR_Denominations
		(Type,					Value)
VALUES		('HR_DISABLE_EUROPE',		    	    0), ---- [0: (No Change) <-> 1: (Removes) Bird Figure Cult, Druidism, Forn Sidr /*]
		('HR_DISABLE_EUROPE_MODERN',	    	    0), ---- [0: (No Change) <-> 1: (Removes) Spiritism]
		...
		('HR_DISABLE_NORTH_AMERICA',		    0); ---- [0: (No Change) <-> 1: (Removes) Angakkunngurniq, Datura Cult, Kachina, Mahoma, Pohakantenna, Scaanaang]
								---- [/* Note: 'HR_DISABLE_EUROPE' does not affect the 'HR_FORN_SIDR_LITE_EXCEPTION' option if Historical Religions Lite is enabled.]
...
INSERT INTO HR_Denominations
		(Type,					Value)
VALUES		('HR_DISABLE_MI_CHOS',		    	    0); ---- [0: (No Change) <-> 1: (Removes) Mi-chos /*]
								---- [/* Note: This option may be used independently of 'HR_DISABLE_ASIA'.]
...
-- Lite Mode: 24
--
-- /* 'HR_CHRISTIAN_DENOMINATIONS' and 'HR_DISABLE_UNUSED_BASE_RELIGIONS' can be toggled to remove an additional 3 and 4 religions, respectively.
